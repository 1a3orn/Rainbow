...
def read_args():
    ...
    parser.add_argument('--record_every', type=int, default=60*5, help='wait at least x seconds between episode recordings (default is to use environment specific presets)')
